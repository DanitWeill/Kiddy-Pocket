...
//  Pocket Money
//
//  Created by Danit on 26/08/2022.
//
...
class SubtractVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        nameLabel.text = "Subtract Money from \(nameToPass)  Pocket"
    ...
    @IBAction func subtractButtonPressed(_ sender: UIButton) {
        ...
        if amountTextField.text != ""{
            amountSubtract = Int(amountTextField.text!)!
            ...
            db.runTransaction({ (transaction, errorPointer) -> Any? in
                ...
                if let error = error {
                    ...
                    sumReference.collection("history").addDocument(data: [
                        ...
                        "amount added": -self.amountSubtract,
                        ...
                        if let err = err {
                            ...
                            if let dateMoneyAdded = self.dateMoneyAdded as? String, let amountToSubtract = self.amountSubtract as? Int, let currencyAdded = self.currency as? String {
                                let newDate = DateHistoryArray(dateMoneyAdded: dateMoneyAdded, amountAdded: Float(amountToSubtract), currencyAdded: currencyAdded)
            ...
            self.showToast(message: "Subtracted!", font: .systemFont(ofSize: 12.0))
